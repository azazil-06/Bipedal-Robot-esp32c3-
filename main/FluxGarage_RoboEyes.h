...
bool girlVersion = 1; // if true, draw cute eyebrows and eyelashes
...
void drawEyes(){
  ...
  // Draw girl version details (eyelashes only)
  if (girlVersion) {
    // --- Left Eye Details ---
    // Eyelashes (three diagonal lashes sweeping up and left - 2px thick)
    display->drawLine(eyeLx + 2, eyeLy + 2, eyeLx - 5, eyeLy - 3, MAINCOLOR);
    display->drawLine(eyeLx + 2, eyeLy + 3, eyeLx - 5, eyeLy - 2, MAINCOLOR);
    
    display->drawLine(eyeLx + 8, eyeLy, eyeLx + 4, eyeLy - 5, MAINCOLOR);
    display->drawLine(eyeLx + 8, eyeLy + 1, eyeLx + 4, eyeLy - 4, MAINCOLOR);
    
    display->drawLine(eyeLx + 14, eyeLy, eyeLx + 12, eyeLy - 6, MAINCOLOR);
    display->drawLine(eyeLx + 14, eyeLy + 1, eyeLx + 12, eyeLy - 5, MAINCOLOR);
    
    // --- Right Eye Details ---
    if (!cyclops) {
      // Eyelashes (three diagonal lashes sweeping up and right - 2px thick)
      display->drawLine(eyeRx + eyeRwidthCurrent - 2, eyeRy + 2, eyeRx + eyeRwidthCurrent + 5, eyeRy - 3, MAINCOLOR);
      display->drawLine(eyeRx + eyeRwidthCurrent - 2, eyeRy + 3, eyeRx + eyeRwidthCurrent + 5, eyeRy - 2, MAINCOLOR);
      
      display->drawLine(eyeRx + eyeRwidthCurrent - 8, eyeRy, eyeRx + eyeRwidthCurrent - 4, eyeRy - 5, MAINCOLOR);
      display->drawLine(eyeRx + eyeRwidthCurrent - 8, eyeRy + 1, eyeRx + eyeRwidthCurrent - 4, eyeRy - 4, MAINCOLOR);
      
      display->drawLine(eyeRx + eyeRwidthCurrent - 14, eyeRy, eyeRx + eyeRwidthCurrent - 12, eyeRy - 6, MAINCOLOR);
      display->drawLine(eyeRx + eyeRwidthCurrent - 14, eyeRy + 1, eyeRx + eyeRwidthCurrent - 12, eyeRy - 5, MAINCOLOR);
    }
  }
